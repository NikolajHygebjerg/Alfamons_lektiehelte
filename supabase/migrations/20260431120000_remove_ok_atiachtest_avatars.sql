-- Opfølgning hvis 20260406120000 allerede er kørt før 'ok' og 'atiachtest' blev tilføjet til listen.
-- Idempotent: tom junk-mængde giver ingen sletninger.
...
WHERE lower(trim(a.name)) IN ('ok', 'atiachtest');
